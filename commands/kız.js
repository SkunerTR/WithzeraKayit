...
exports.run = async (client, message, args) => {
    ...
    */
    try {
        ...
        if (!miaf) return message.channel.send(new Discord.MessageEmbed().setDescription(`İsim belirtmelisin. **Örnek: Piece**`).setFooter(`Withzera - Kayıt Sistemi`).setColor("RANDOM").setTimestamp());
